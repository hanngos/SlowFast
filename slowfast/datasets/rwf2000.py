...
class Rwf2000(torch.utils.data.Dataset):
    """
    Rwf2000 video loader. Construct the Rwf2000 video loader, then sample
    ...
    def __init__(self, cfg, mode, num_retries=100):
        """
        Construct the Rwf2000 video loader with a given csv file. The format of
        the csv file is:
        ```
        ...
        assert mode in [
            ...
            "val",
            "test",
        ], "Split '{}' not supported for Rwf2000".format(mode)
        self.mode = mode
        self.cfg = cfg
        ...
        logger.info("Constructing Rwf2000 {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        ), "Failed to load Rwf2000 split {} from {}".format(
            self._split_idx, path_to_file
        )
        logger.info(
            "Constructing Rwf2000 dataloader (size: {} skip_rows {}) from {} ".format(
